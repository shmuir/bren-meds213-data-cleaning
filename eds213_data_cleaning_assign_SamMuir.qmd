...
- There are also 4,626 rows where total cover is not equal to 100
...
cover_total_fixed <- cover_fixed %>%
  mutate(Snow_cover = ifelse(Snow_cover + Water_cover + Land_cover < 100, NA, Snow_cover),
         Water_cover = ifelse(Snow_cover + Water_cover + Land_cover < 100, NA, Water_cover),
         Land_cover = ifelse(Snow_cover + Water_cover + Land_cover < 100, NA, Land_cover),
